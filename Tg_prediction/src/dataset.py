...
if top:
    dataset_name  = 'fixed_NEW_Tg_top_dataset.csv'
    trainset_name = 'fixed_NEW_Tg_top'
else:
    dataset_name =  'fixed_NEW_Tg_dataset.csv'
    trainset_name = 'fixed_NEW_Tg'
if repre == 'S0':
    if any([extens,Flip]):
...
#        train_data = data_preprocessing(f'{root}/{trainset_name}_train_split_{i}.csv',ppty,repre,extens,Flip)
...
#        print(f"data generated : ../data/{filename}_split{i}.h5\n")
#        h5f = h5py.File(f'../data/{filename}_split{i}.h5','w')
