...
early_stop = EarlyStopping(monitor='val_loss', patience=20000)

model_path = 'model'
filename = os.path.join(model_path, f'{trainset}_check.h5')
checkpoint = ModelCheckpoint(filename, monitor='val_loss', verbose=100, save_best_only=True, mode='auto')
