...
random.seed(47945)
data_pan = pd.read_csv('../data/NEW_Tg_dataset.csv',sep=',',names=['S0','S1','S2','S3','exp','syn','Tg','Density','Solu','Tc'],skiprows=1)
#  print(data_pan)
...
for d in data_ind:
  test,train = d
  data_pan.iloc[train].to_csv(f'../data/NEW_Tg_train_{n}.csv')
  data_pan.iloc[test].to_csv(f'../data/NEW_Tg_test_{n}.csv')
  n +=1
for lang in ['S2','S0']:
    #  print(lang)
    generate_dict('../data/NEW_Tg_dataset.csv',lang)
