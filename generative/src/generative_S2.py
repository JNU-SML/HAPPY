...
train, test, MAX_LEN, NCHARS = h5_Dataset('../data/HAPPY_dk_split_400.h5').load()
bs = 256
...
class VAE(nn.Module):
    def __init__(self, x_dim, h_dim1, h_dim2, z_dim):
        ...
        self.linear_4 = nn.Linear(384, 24)
    ...
    def decode(self, z):
        ...
        z = z.view(z.size(0), 1, z.size(-1)).repeat(1, 23, 1)
...
z_dim = 16
vae = VAE(x_dim=25, h_dim1=256, h_dim2=128 ,z_dim=z_dim)
...
import pandas as pd
dicts = pd.read_csv('../data/S2_dictionary',index_col=0)
